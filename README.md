...
大家好，我是菜鸟程序员一枚，该项目是跟着鱼皮哥学习的，项目很好，我会努力学习的。
...
第一阶段的目标是要制作本地代码生成器（基于命令行的脚手架），看起来实现很困难，那就先把需求进行**拆解**，分为两个阶段：本地代码生成器 + 基于命令行的脚手架。
...
中文文档：[FreeMarker 中文官方参考手册 (foofun.cn)](http://freemarker.foofun.cn/toc.html)
